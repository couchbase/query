...
func (b *storeKeyspace) CreatePrimaryIndex() (datastore.PrimaryIndex, errors.Error) {
	if b.primary != nil {
		return b.primary, nil
	}
...
func (b *storeKeyspace) CreateIndex(name string, equalKey, rangeKey expression.Expressions, using datastore.IndexType) (datastore.Index, errors.Error) {
	return nil, errors.NewError(nil, "Not supported.")
}

func (b *storeKeyspace) Fetch(keys []string) ([]datastore.Pair, errors.Error) {
...
func (b *storeKeyspace) FetchOne(key string) (value.Value, errors.Error) {
