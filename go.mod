...
require (
	...
	github.com/blevesearch/bleve/v2 v2.4.5-0.20250425150105-df801790e6e0 // indirect
	...
	github.com/blevesearch/sear v0.2.10-0.20250408144211-734aeeaa871d // indirect
