...
func NewVirtualKSNotSupportedError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19000, IKey: "datastore.virtual.keyspace.not_supported", ICause: e,
...
func NewVirtualKSNotImplementedError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19001, IKey: "datastore.virtual.keyspace.not_implemented", ICause: e,
...
func NewVirtualKSIdxerNotFoundError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19002, IKey: "datastore.virtual.keyspace.not_found", ICause: e,
...
func NewVirtualIdxNotFoundError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19003, IKey: "datastore.virtual.indexer.not_found", ICause: e,
...
func NewVirtualIdxerNotSupportedError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19004, IKey: "datastore.virtual.indexer.not_supported", ICause: e,
...
func NewVirtualIdxNotImplementedError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19005, IKey: "datastore.virtual.index.not_implemented", ICause: e,
...
func NewVirtualIdxNotSupportedError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19006, IKey: "datastore.virtual.index.not_supported", ICause: e,
...
func NewVirtualScopeNotFoundError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19007, IKey: "datastore.virtual.scope_not_found", ICause: e,
...
func NewVirtualBucketCreateScopeError(s string, e error) Error {
	return &err{level: EXCEPTION, ICode: 19009, IKey: "datastore.virtual.create_scope", ICause: e,
...
func NewVirtualBucketDropScopeError(s string, e error) Error {
	return &err{level: EXCEPTION, ICode: 19010, IKey: "datastore.virtual.drop_scope", ICause: e,
...
func NewVirtualKeyspaceNotFoundError(e error, msg string) Error {
	return &err{level: EXCEPTION, ICode: 19011, IKey: "datastore.virtual.keyspace_not_found", ICause: e,
...
func NewVirtualBucketCreateCollectionError(c string, e error) Error {
	return &err{level: EXCEPTION, ICode: 19012, IKey: "datastore.virtual.create_collection", ICause: e,
...
func NewVirtualBucketDropCollectionError(c string, e error) Error {
	return &err{level: EXCEPTION, ICode: 19013, IKey: "datastore.virtual.drop_collection", ICause: e,
