...
*/
func NewVarPop(operands expression.Expressions, flags uint32, wTerm *WindowTerm) Aggregate {
	rv := &VarPop{
		*NewAggregateBase("var_pop", operands, flags, wTerm),
	}
...
func (this *VarPop) Constructor() expression.FunctionConstructor {
	return func(operands ...expression.Expression) expression.Function {
		return NewVarPop(operands, uint32(0), nil)
	}
}
