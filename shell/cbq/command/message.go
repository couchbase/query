...
const (
	...
	UADVISE        = " Run ADVISE on all queries in the specified file or that are read from standard input, if a file is not " +
		"provided with the -file option. \n\tFor example: -advise -file queries.txt"
