...
const (
	...
	API_STMT_ALTER_COLLECTION            = 28745
	API_STMT_CREATE_CATALOG              = 28746
	API_STMT_ALTER_CATALOG               = 28747
	API_STMT_DROP_CATALOG                = 28748
	API_STMT_CREATE_CREDENTIALSTORE      = 28749
	API_STMT_ALTER_CREDENTIALSTORE       = 28750
	API_STMT_DROP_CREDENTIALSTORE        = 28751
	API_ADMIN_CATALOGS                   = 28752
)
...
var _EVENT_TYPE_MAP = map[string]uint32{
	...
	"ALTER_COLLECTION":          API_STMT_ALTER_COLLECTION,
	"CREATE_CATALOG":            API_STMT_CREATE_CATALOG,
	"ALTER_CATALOG":             API_STMT_ALTER_CATALOG,
	"DROP_CATALOG":              API_STMT_DROP_CATALOG,
	"CREATE_CREDENTIALSTORE":    API_STMT_CREATE_CREDENTIALSTORE,
	"ALTER_CREDENTIALSTORE":     API_STMT_ALTER_CREDENTIALSTORE,
	"DROP_CREDENTIALSTORE":      API_STMT_DROP_CREDENTIALSTORE,
}
