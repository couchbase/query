...
const RANGE_SPECIAL_SPAN = (RANGE_SELF_SPAN | RANGE_FULL_SPAN | RANGE_WHOLE_SPAN | RANGE_VALUED_SPAN | RANGE_EMPTY_SPAN | RANGE_MISSING_SPAN | RANGE_NULL_SPAN | RANGE_NOT_VALUED_SPAN)
