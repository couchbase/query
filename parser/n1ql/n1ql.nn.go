...
{ logToken("BETWEEN"); return BETWEEN }
    case 44:  //[bB][iI][nN][aA][rR][yY]/
{ logToken("BINARY"); return BINARY }
    case 45:  //[bB][oO][oO][lL][eE][aA][nN]/
{ logToken("BOOLEAN"); return BOOLEAN }
    case 46:  //[bB][rR][eE][aA][kK]/
{ logToken("BREAK"); return BREAK }
    case 47:  //[bB][uU][cC][kK][eE][tT]/
...
{ logToken("CAST"); return CAST }
    case 52:  //[cC][lL][uU][sS][tT][eE][rR]/
{ logToken("CLUSTER"); return CLUSTER }
    case 53:  //[cC][oO][lL][lL][aA][tT][eE]/
{ logToken("COLLATE"); return COLLATE }
    case 54:  //[cC][oO][lL][lL][eE][cC][tT][iI][oO][nN]/
{ logToken("COLLECTION"); return COLLECTION }
    case 55:  //[cC][oO][mM][mM][iI][tT]/
{ logToken("COMMIT"); return COMMIT }
    case 56:  //[cC][oO][nN][nN][eE][cC][tT]/
{ logToken("CONNECT"); return CONNECT }
    case 57:  //[cC][oO][nN][tT][iI][nN][uU][eE]/
{ logToken("CONTINUE"); return CONTINUE }
    case 58:  //[cC][rR][eE][aA][tT][eE]/
{ logToken("CREATE"); return CREATE }
    case 59:  //[dD][aA][tT][aA][bB][aA][sS][eE]/
{ logToken("DATABASE"); return DATABASE }
    case 60:  //[dD][aA][tT][aA][sS][eE][tT]/
{ logToken("DATASET"); return DATASET }
    case 61:  //[dD][aA][tT][aA][sS][tT][oO][rR][eE]/
{ logToken("DATASTORE"); return DATASTORE }
    case 62:  //[dD][eE][cC][lL][aA][rR][eE]/
{ logToken("DECLARE"); return DECLARE }
    case 63:  //[dD][eE][cC][rR][eE][mM][eE][nN][tT]/
{ logToken("DECREMENT"); return DECREMENT }
    case 64:  //[dD][eE][lL][eE][tT][eE]/
{ logToken("DELETE"); return DELETE }
    case 65:  //[dD][eE][rR][iI][vV][eE][dD]/
{ logToken("DERIVED"); return DERIVED }
    case 66:  //[dD][eE][sS][cC]/
{ logToken("DESC"); return DESC }
    case 67:  //[dD][eE][sS][cC][rR][iI][bB][eE]/
{ logToken("DESCRIBE"); return DESCRIBE }
    case 68:  //[dD][iI][sS][tT][iI][nN][cC][tT]/
