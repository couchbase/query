...
func TestStatements(t *testing.T) {
	...
	runStmt(qc, "CREATE INDEX index_custId_D ON customer(custId) WHERE test_id = \"delete_statement\"")
	runStmt(qc, "CREATE INDEX index_custId_U ON customer(custId) WHERE test_id = \"update_statement\"")
	...
	runStmt(qc, "DROP INDEX customer.index_custId_D")
	runStmt(qc, "DROP INDEX customer.index_custId_U")
