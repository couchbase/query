...
collections=('orders,_default,transactions' 'orders,_default,durability' 'orders,_default,flattenkeys' 'orders,_default,lkm' 'orders,_default,ss' 'orders,_default,ts')
