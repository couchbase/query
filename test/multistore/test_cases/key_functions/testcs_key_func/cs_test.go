...
/*
Insert data into the purchase bucket created earlier
using the statements in insert_purchase.json.
*/
func TestInsertCaseFiles(t *testing.T) {
	fmt.Println("\n\nInserting values into Bucket for Key Functions \n\n ")
	qc := Start_test()
...
func TestCleanupData(t *testing.T) {
	...
	_, _, errcs := Run_test(qc, "delete from purchase where test_id = \"key_func\"")
	if errcs != nil {
