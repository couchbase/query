...
/*
Insert data into the product and orders buckets created earlier
...
func TestCleanupData(t *testing.T) {
	...
	_, _, errcs := Run_test(qc, "delete from product where test_id = \"where_func\"")
	if errcs != nil {
