...
/*
Insert data into the review bucket created earlier
using the statements in insert_review.json.
*/
func TestInsertCaseFiles(t *testing.T) {
	fmt.Println("\n\nInserting values into Bucket for Comparison Functions \n\n ")
	qc := start()
...
func TestCleanupData(t *testing.T) {
	...
	_, _, errfs := Run_test(qc, "delete from review where test_id = \"comp_func\"")
	if errfs != nil {
