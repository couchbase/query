...
function repo_setup {
    ...
    (cd ../godbc; git checkout 7c2b871f63b894e46627da5e5aa5fffb3a017878)
    (cd ../hebrew; git checkout fd6a0a1013434e4ba8cae73f6c80d2433d72ed0b)
    (cd ../blance; git checkout b2ec44a33677b3c64c516ed9e9c49721e266a58a)
}
