...
DevStandaloneSetup() {
    ...
    # bleve version
       if [[ ! -d ../../blevesearch/bleve/v2 ]]; then
           (cd ../../blevesearch; git clone -b v2.3.3 http://github.com/blevesearch/bleve.git bleve/v2)
       fi
    # zapx versions
       if [[ ! -d ../../blevesearch/zapx/v11 ]]; then
           (cd ../../blevesearch; git clone -b v11.3.3 http://github.com/blevesearch/zapx.git zapx/v11)
       fi
       if [[ ! -d ../../blevesearch/zapx/v12 ]]; then
           (cd ../../blevesearch; git clone -b v12.3.3 http://github.com/blevesearch/zapx.git zapx/v12)
       fi
       if [[ ! -d ../../blevesearch/zapx/v13 ]]; then
           (cd ../../blevesearch; git clone -b v13.3.3 http://github.com/blevesearch/zapx.git zapx/v13)
       fi
       if [[ ! -d ../../blevesearch/zapx/v14 ]]; then
           (cd ../../blevesearch; git clone -b v14.3.3 http://github.com/blevesearch/zapx.git zapx/v14)
       fi
       if [[ ! -d ../../blevesearch/zapx/v15 ]]; then
           (cd ../../blevesearch; git clone -b v15.3.3 http://github.com/blevesearch/zapx.git zapx/v15)
       fi
