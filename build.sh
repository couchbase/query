...
DevStandaloneSetup() {
    ...
    # zapx versions
       if [[ ! -d ../../blevesearch/zapx/v11 ]]; then
           (cd ../../blevesearch; git clone -b v11.3.4 http://github.com/blevesearch/zapx.git zapx/v11)
       fi
       if [[ ! -d ../../blevesearch/zapx/v12 ]]; then
           (cd ../../blevesearch; git clone -b v12.3.4 http://github.com/blevesearch/zapx.git zapx/v12)
       fi
       if [[ ! -d ../../blevesearch/zapx/v13 ]]; then
           (cd ../../blevesearch; git clone -b v13.3.4 http://github.com/blevesearch/zapx.git zapx/v13)
       fi
       if [[ ! -d ../../blevesearch/zapx/v14 ]]; then
           (cd ../../blevesearch; git clone -b v14.3.4 http://github.com/blevesearch/zapx.git zapx/v14)
       fi
       if [[ ! -d ../../blevesearch/zapx/v15 ]]; then
           (cd ../../blevesearch; git clone -b v15.3.4 http://github.com/blevesearch/zapx.git zapx/v15)
       fi
