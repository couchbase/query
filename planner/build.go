...
const (
	...
	BUILDER_HAS_VECTOR_RERANK
)

const BUILDER_PRESERVED_FLAGS = (BUILDER_PLAN_HAS_ORDER | BUILDER_HAS_EARLY_ORDER | BUILDER_ORDER_MODIFIED | BUILDER_HAS_VECTOR_RERANK)
