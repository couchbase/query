...
// This package is copied from the golang source distribution. It will
// be modified to add parallelism.
...
func notify(parent childChannel) {
	if parent != nil {
		parent <- false
	}
}
...
type reverse struct {
	// This embedded sort.Interface permits Reverse to use the methods of
	// another sort.Interface implementation.
	sort.Interface
}
...
//    but sort.Interface has only Swap as operation.
